...
test('check for total 659$ bill, with the role of employee (30% discount), discount amount should be ~197.7$', () => {
  const cart = new Cart();
...
test('check for total 659$ bill, with the role of affiliate (10% discount), discount amount should be ~65.9$', () => {
  const cart = new Cart();
  cart.addItem(new Product('smartphone', 659, ProductCategory['electronic']), 1);
...
test('check for total 659$ bill, with the role of loyalty_customer (5% discount), discount amount should be ~32.95$', () => {
  const cart = new Cart();
  cart.addItem(new Product('smartphone', 659, ProductCategory['electronic']), 1);
...
test('check for total 1124$ bill, with the mix of grocery product, affiliate role (10% discount policy), discount amount should be ~89.9$', () => {
  const cart = new Cart();
